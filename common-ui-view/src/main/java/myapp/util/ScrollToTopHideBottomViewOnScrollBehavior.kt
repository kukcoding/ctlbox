 ...
 */
open class ScrollToTopHideBottomViewOnScrollBehavior<V : View?> : CoordinatorLayout.Behavior<V> {
    ...
    override fun onNestedScroll(
        ...
        // Timber.d("dyConsumed=${dyConsumed},  consumed=${if (consumed.isNotEmpty()) consumed[0] else "X"}")
        if (dyConsumed > 0) {
            slideDown(child)
