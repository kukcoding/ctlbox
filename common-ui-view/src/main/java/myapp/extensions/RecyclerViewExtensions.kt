...
import myapp.ui.recyclerview.TRLinearSmoothScroller
...
fun RecyclerView.smoothScrollToViewHolder(vh: RecyclerView.ViewHolder) = TRLinearSmoothScroller(
    context,
...
fun RecyclerView.smoothScrollToItemPosition(position: Int) = TRLinearSmoothScroller(
    context,
    snapPreference = LinearSmoothScroller.SNAP_TO_START,
    scrollMsPerInch = 60f
).apply {
