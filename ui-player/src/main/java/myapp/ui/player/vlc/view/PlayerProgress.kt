...
class PlayerProgress : View {
    ...
    private val progressColor = ContextCompat.getColor(context, R.color.color_white)
    private val boostColor = ContextCompat.getColor(context, R.color.color_orange_700)
